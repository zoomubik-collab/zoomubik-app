...
`, this.el);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0039549c1a4098672eb827c3d6b2c8fcf8f41c53', "aria-disabled": disabled ? 'true' : null, onFocus: this.onFocus, onBlur: this.onBlur, class: Object.assign({}, theme.createColorClasses(color, {
                [mode]: true,
            ...
            })) }, index.h("div", { key: '72f0860a8c46aa493af28819d2e49689358b8357', class: "intersection-tracker", ref: (el) => (this.intersectionTrackerRef = el) }), this.renderDatetime(mode)));
    }
